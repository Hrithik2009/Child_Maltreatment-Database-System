                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="email" id="input-email" class="form-control form-control-alternative" placeholder="Email.." name="authority_email" value="<%=rs.getString("email") %>" required>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group focused">
                        ...
                        <input type="text" id="input-first-name" class="form-control form-control-alternative" placeholder="City.." name="authority_city"  value="<%=rs.getString("city") %>" required >
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group focused">
                        <label class="form-control-label" for="input-last-name">Password</label>
                        <input type="text" id="input-last-name" class="form-control form-control-alternative" placeholder="Set Password" name="authority_password"  value="<%=rs.getString("password") %>" required >
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="row">
                    <div class="col-lg-4">
                      <div class="form-group focused">
                        ...
                        <input type="text" id="input-city" class="form-control form-control-alternative" placeholder="mobile no" name="authority_mob_no"  value="<%=rs.getString("mob_no") %>" required>
                      </div>
                    </div>
                             <%
