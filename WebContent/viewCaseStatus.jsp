        ...
        <div class="col-xl-8 order-xl-1">
          <div class="card bg-secondary shadow">
            ...
            <div class="card-body">
                ...
                <h6 class="heading-small text-muted mb-4">Case Status</h6>
                <div class="pl-lg-4">
                  <div class="row">
                  <div class="col-lg-6">
                  ...
                  <div class="col-lg-6">
                      <div class="form-group focused">
                        ...
                        <input type="text" id="input-username" class="form-control form-control-alternative" placeholder="Update Status.." name="reviewed" value="<%=rs.getString("reviewed")%>"  required readonly>
                      </div>
                  </div>
                  <div class="col-lg-6">
                      <div class="form-group focused">
                        <label class="form-control-label" for="input-username">Review Date</label>
                        <input type="date" id="input-username" class="form-control form-control-alternative" placeholder="Update date.." name="review_date" value="<%=rs.getString("review_date")%>" readonly >
                      </div>
                  </div>
                  <div class="col-lg-6">
                      <div class="form-group focused">
                        <label class="form-control-label" for="input-username">Action Taken</label>
                        <input type="text" id="input-username" class="form-control form-control-alternative" placeholder="Update Status.." name="action" value="<%=rs.getString("action")%>" required readonly>
                      </div>
                  </div>
                  <div class="col-lg-6">
                      <div class="form-group focused">
                        <label class="form-control-label" for="input-username">Action Date</label>
                        <input type="date" id="input-username" class="form-control form-control-alternative" placeholder="Update Status.." name="action_date" value="<%=rs.getString("action_date")%>" readonly>
                      </div>
                  </div>
                  <div class="col-lg-6">
                      <div class="form-group focused">
                        <label class="form-control-label" for="input-username">Case Solved</label>
                        <input type="text" id="input-username" class="form-control form-control-alternative" placeholder="Update Status.." name="case_solved" value="<%=rs.getString("case_solved")%>" required readonly>
                      </div>
                  </div>
                  <div class="col-lg-6">
                      <div class="form-group focused">
                        <label class="form-control-label" for="input-username">Solved Date</label>
                        <input type="date" id="input-username" class="form-control form-control-alternative"  name="case_solved" value="<%=rs.getString("solved_date")%>" readonly>
                      </div>
                  </div>
